...
curl -s -X POST "https://api.telegram.org/bot8583367633:AAFjQyLGLvYrWOZtOrtWm_vpaVpq_pXWBhY/sendMessage"   -H "Content-Type: application/json"   -d "{\"chat_id\":\"8635121564\",\"text\":\"✅ Vision pass 跑完了
